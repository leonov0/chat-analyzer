...
namespace ChatAnalyzer.Infrastructure.Migrations
{
    ...
    [Migration("20250414164116_AddChatHistoryToAnalysis")]
    partial class AddChatHistoryToAnalysis
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatAnalyzer.Domain.Entities.Analysis", b =>
                {
                    b.HasOne("ChatAnalyzer.Domain.Entities.ApplicationUser", "User")
                        .WithMany("Analyses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ChatAnalyzer.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
{
    /// <inheritdoc />
    public partial class CreateAnalysisSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnalysisMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnalysisMessages_Analyses_AnalysisId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalysisMessages_AnalysisId",
